  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Quem somos, porque escolhemos a Namíbia e o que procurámos encontrar." />
      </Head>
      ...
      <main style={{
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--grey)', fontStyle: 'italic', fontFamily: 'var(--font-body)', fontSize: '0.9rem' }}>
            [ Espaço para preencher: quem somos, porque escolhemos a Namíbia, o que procurámos encontrar ]
          </p>
        </div>
      </main>
    </>
